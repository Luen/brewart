    ...
    return (
        (<section id="brewprints" className="mt-6 mx-auto max-w-3xl">
            ...
            <div className="flex justify-center gap-4 my-4">
                ...
                <button onClick={sortByBitterness} className="px-4 py-2 bg-gray-500 text-white font-semibold rounded-lg shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-75">
                    {isBitternessAsc ? 'Sort by Bitterness (Asc)' : 'Sort by Bitterness (Desc)'}
                </button>
                <button onClick={sortByColour} className="px-4 py-2 bg-gray-500 text-white font-semibold rounded-lg shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-75">
